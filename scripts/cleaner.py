...
# Simple text cleaning function I wrote.
# Eliminates extra spaces, any text inside of parentheses, and any character markers
def clean(txt):
...
# Efficient function to split a text into sentences
